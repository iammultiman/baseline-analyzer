        ...
        <div className="flex flex-col justify-center min-h-screen py-12">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              AI-powered code repository analysis against web platform baseline standards. 
              Get actionable insights to improve your project&apos;s compatibility with modern web standards.
            </p>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600">
                  Advanced AI analyzes your code against the latest web platform baseline standards.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Instant Insights</h3>
                <p className="text-gray-600">
                  Get actionable recommendations to improve your project&apos;s web standards compliance.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">CI/CD Integration</h3>
                <p className="text-gray-600">
                  Seamlessly integrate with your development workflow for continuous analysis.
                </p>
              </div>
            </div>
          </div>
